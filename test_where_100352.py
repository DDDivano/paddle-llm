...
np.random.seed(33)
x = generate_array(shape=[1, 100352], dtype=np.float32, value_range=(-1, 1))
y = generate_array(shape=[1, 100352], dtype=np.float32, value_range=(-1, 1))
condition = generate_array(shape=[1, 100352], dtype=np.bool_, value_range=(-1, 1))
