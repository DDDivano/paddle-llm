...
np.random.seed(33)
input_data = generate_array(shape=[1, 4096, 100352], dtype=np.float32, value_range=(-1, 1))
input_data_gradout = generate_array(shape=[1, 4096, 100352], dtype=np.float32, value_range=(-1, 1))
